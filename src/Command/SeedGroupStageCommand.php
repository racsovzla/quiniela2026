...
#[AsCommand(name: 'app:seed-group-stage', description: 'Create FIFA 2026 groups A-L and knockout phase groups')]
class SeedGroupStageCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        foreach (Fixture::knockoutStages() as $stage) {
        ...
        $io->success('Grupos A-L y fases eliminatorias creados o verificados.');
